...
urlpatterns = patterns('',
                       ...
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/create_query/saveadvquery/(?P<query_string>[\w\(\)\%\ \,\[\]]+)/$', views.save_query_adv, name='save_query_adv'),
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/create_query/savestdquery/(?P<query_string>[\w\(\)\%\ \,\[\]]+)/$', views.save_query_std, name='save_query_std'),
