...
urlpatterns = patterns('',
                       ...
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/create_query/saveadvquery/(?P<query_string>[\w\(\)\%\ \,\[\]]+)/$', views.save_to_pool_adv, name='save_adv_query'),
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/create_query/stdquery/(?P<query_string>[\w\(\)\%\ \,\[\]]+)/$',views.check_API_std,name='std_query'),
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/create_query/savestdquery/(?P<query_string>[\w\(\)\%\ \,\[\]]+)/$', views.save_to_pool_std, name='save_std_query'),
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/create_query/saveadvquerynottopool/(?P<query_string>[\w\(\)\%\ \,\[\]]+)/$', views.save_query_adv,name='save_std_query_not_to_pool'),
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/create_query/savestdquerynottopool/(?P<query_string>[\w\(\)\%\ \,\[\]]+)/$', views.save_query_std,name='save_std_query_not_to_pool'),
