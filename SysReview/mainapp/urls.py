...
urlpatterns = patterns('',
                       ...
                       # url(r'^reviews/(?P<review_name_slug>[\w\-]+)/query_results/$',views.query_results,title='query_results'),
                       ...
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/abstract_pool/(?P<id>\d+)/remove_from_ap/$',views.remove_from_ap,name='remove_from_ap'),
