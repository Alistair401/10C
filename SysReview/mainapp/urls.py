...
urlpatterns = patterns('',
                       ...
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/queries/completequeries',views.query_api,name='complete_queries'),
                       url(r'^reviews/(?P<review_name_slug>[\w\-]+)/queries/total_results',views.check_total_results,name='total_results'),
                       ...
                       url(r'^syntax/$',views.syntax,name='syntax'),
                      )
